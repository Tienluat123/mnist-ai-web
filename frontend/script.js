...
const themes = {
    pixel: {
        name: "Style Mộng Mơ (Pixel)",
        desc: "Input: 784 features (Raw Pixel)",
        bg: "#fffffe", headline: "#1f1235", btn: "#ff6e6c", secondary: "#67568c", tertiary: "#fbdd74"
    },
    sobel: {
        name: "Style Công Nghệ (Sobel)",
        desc: "Input: 1568 features (Gốc + Cạnh)",
        bg: "#f0f4f8", headline: "#094067", btn: "#3da9fc", secondary: "#90b4ce", tertiary: "#d8eefe"
    },
    block: {
        name: "Style Tối Giản (Block)",
        desc: "Input: 196 features (Nén 4x)",
